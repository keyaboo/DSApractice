...
have for loop over left, nested for loop over right. dp array of what exactly though? it could be diff, a value
similar to target at the indices of left index swap (x), right index swap (y)
 */
